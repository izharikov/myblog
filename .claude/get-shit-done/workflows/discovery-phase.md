...
See D:/work/blog/.claude/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using D:/work/blog/.claude/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using D:/work/blog/.claude/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from D:/work/blog/.claude/get-shit-done/templates/discovery.md
...
Use D:/work/blog/.claude/get-shit-done/templates/discovery.md.
