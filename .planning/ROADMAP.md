...
- [x] **Phase 4: SolidJS Islands** - ThemeToggle island (FOUC-free), mobile menu/drawer island; dark mode wiring across all Tailwind dark: variants (completed 2026-03-27)
